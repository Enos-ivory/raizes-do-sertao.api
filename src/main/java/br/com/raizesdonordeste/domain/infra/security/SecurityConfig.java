    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // REGRAS DE ADMIN (Uso de hasRole assume que no banco o perfil é "ROLE_ADMIN")
                        ...
                        // BLOQUEIO DE SEGURANÇA (erro 401/403)
                        .anyRequest().authenticated()
                )
                // Adiciona o filtro na corrente de segurança do Spring
